...
variable "automatic_channel_upgrade" {
  description = "The upgrade channel for this Kubernetes Cluster. Possible values are none, patch, rapid, node-image and stable. Omitting this field sets this value to stable."
  type        = string
  default     = "stable"
}
