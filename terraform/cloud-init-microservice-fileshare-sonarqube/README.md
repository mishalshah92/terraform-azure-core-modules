# Azure Cloud Init Microservice Fileshare Sonarqube

Terraform modules to generate the cloud-init file for deploying micro-service on VM with FileShare mount for Sonarqube.
...
module "cloud-init-microservice-fileshare-sonarqube" {
  source = "git::https://github.com/mishalshah92/terraform-azure-core-modules.git//terraform/cloud-init-microservice-fileshare-sonarqube"
