# Azure Cloud Init Microservice Datadisk

Terraform modules to generate the cloud-init file for deploying container at start and mounting datadisk.
...
module "cloud-init-microservice" {
  source = "git::https://github.com/mishalshah92/terraform-azure-core-modules.git//terraform/cloud-init-microservice"
