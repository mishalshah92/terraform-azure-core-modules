...
- Adding below modules
    ...
    - [application-insights](src/application-insight)  
    ...
    - [database-server-postgresql](src/database-postgresql)
    ...
    - [linux-virtual-machine](src/virtual-machine-linux)
    - [linux-virtual-machine-scaleset](src/virtual-machine-scaleset-linux)
