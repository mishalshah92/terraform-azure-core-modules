resource "azurerm_storage_account" "storage_account" {
  ...
  dynamic "blob_properties" {
    ...
    content {
      ...
      dynamic "cors_rule" {
        for_each = lookup(blob_properties.value, "cors_rule", null) == null ? {} : blob_properties.value.cors_rule
        content {
  ...
  dynamic "queue_properties" {
    ...
    content {
      ...
      dynamic "cors_rule" {
        for_each = lookup(queue_properties.value, "cors_rule", null) == null ? {} : queue_properties.value.cors_rule
        content {
          allowed_headers    = cors_rule.value.allowed_headers
          allowed_methods    = cors_rule.value.allowed_methods
          allowed_origins    = cors_rule.value.allowed_origins
